...
export const fixtureData: DashboardData = {
  ...
  agents: [
    { id: 'agent_openclaw', name: 'Studio Operator', runtime: 'OpenClaw', mode: 'independent', capabilities: ['balance', 'pay', 'transactions'], capabilityModes: { balance: 'autonomous', pay: 'autonomous', transactions: 'autonomous' }, lastSeen: '1 min ago', verificationStatus: 'active', status: 'connected', installationStatus: 'installed', lastTestedAt: '12 sec ago', lastTestDetail: 'Studio Operator authenticated via CLI' },
    { id: 'agent_hermes', name: 'Revenue Agent', runtime: 'Hermes', mode: 'shared', capabilities: ['balance', 'receive', 'invoice', 'checkout'], capabilityModes: { balance: 'autonomous', receive: 'autonomous', invoice: 'autonomous', checkout: 'autonomous' }, lastSeen: '2 min ago', verificationStatus: 'verified', status: 'connected', installationStatus: 'installed', lastTestedAt: 'Just now', lastTestDetail: 'Revenue Agent authenticated via MCP' },
    { id: 'agent_audit', name: 'Auditor', runtime: 'Custom', mode: 'observe_only', capabilities: ['balance', 'transactions'], capabilityModes: { balance: 'autonomous', transactions: 'autonomous' }, lastSeen: '3 days ago', verificationStatus: 'created', status: 'offline', installationStatus: 'not_installed' },
  ],
  providers: [
