...
pub fn contract_schema() -> serde_json::Value {
    serde_json::json!({
        ...
        "liquidity": schemars::schema_for!(LiquidityStatusResponse),
        "money_request": schemars::schema_for!(MoneyRequest),
        "fund_spend_request": schemars::schema_for!(FundSpendRequest),
        "funding_movement": schemars::schema_for!(FundingMovement),
